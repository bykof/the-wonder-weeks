...
const leapWeeks = [
  ...
  },
  {
    ...
    special: true,
    info: "If your baby is particularly clingy and whiny and cranky at around 29 to 30 weeks, this is not necessarily a sign of another leap. It has simply discovered that the caregiver can go away and leave it alone. As strange as it may sound, this is progress The child is now learning about distance and acquiring a new skill.",
  },
  {
    number: 6,
    start: 33.5,
    end: 37.5,
    info: 'Leap 6 occurs around week 37 and introduces your baby to the "world of categories." During this stage, babies begin to categorize objects, sounds, and experiences, which enhances their understanding of their environment. They may become more curious, explore more actively, and show a preference for certain toys or activities. However, this leap can also lead to more clinginess as they navigate these new cognitive challenges.',
  },
  {
    number: 7,
    start: 41.5,
